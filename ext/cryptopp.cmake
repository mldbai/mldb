...
set(CRYPTOPP_COMPILER_FLAGS_gcc14 "-Wno-error" "-fno-permissive" "-Wno-stringop-overflow" "-Wno-restrict")
if(DEFINED CRYPTOPP_COMPILER_FLAGS_${CMAKE_CXX_COMPILER_ID})
    list(APPEND CMAKE_CXX_FLAGS ${CRYPTOPP_COMPILER_FLAGS_${CMAKE_CXX_COMPILER_ID}})
endif()
