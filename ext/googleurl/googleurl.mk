...
$(eval $(call set_compile_option,$(LIBGOOGLE_URL_SOURCES),-Duint64=uint64_t -Wno-array-bounds clang:-Wno-deprecated-declarations -Imldb/ext -Imldb/ext/googleurl -I$(ICU_INCLUDE_PATH)))
