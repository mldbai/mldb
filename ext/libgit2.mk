...
LIBGIT2_DEFINES_Darwin_aarch64:=-D_GNU_SOURCE -DGIT_ARCH_64 -DGIT_COMMON_CRYPTO -DGIT_CURL -DGIT_OPENSSL -DGIT_THREADS -DGIT_USE_ICONV -DGIT_USE_NSEC -DGIT_USE_STAT_MTIMESPEC -DHAVE_FUTIMENS -DHAVE_QSORT_R -DHAVE_REGCOMP_L -D_FILE_OFFSET_BITS=64 -Dgit2_EXPORTS # -DGIT_SECURE_TRANSPORT
...
$(eval $(call set_compile_option,$(LIBGIT2_SOURCE),-Imldb/ext/libgit2/include -Imldb/ext/libgit2/src -Imldb/ext/libgit2/deps/http-parser $(OPENSSL_INCLUDE_FLAGS) $(LIBGIT2_DEFINES) -Wno-maybe-uninitialized -Wno-bool-operation -Wno-unused-function -Wno-stringop-truncation  -Wno-deprecated-declarations))
