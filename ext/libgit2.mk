...
$(eval $(call set_compile_option,$(LIBGIT2_SOURCE),-Imldb/ext/libgit2/include -Imldb/ext/libgit2/src -Imldb/ext/libgit2/deps/http-parser $(LIBGIT2_DEFINES) -Wno-maybe-uninitialized -Wno-bool-operation -Wno-unused-function -Wno-stringop-truncation))
