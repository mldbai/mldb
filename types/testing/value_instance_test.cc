...
#include "mldb/types/value_instance.h"
...
DECLARE_STRUCTURE_DESCRIPTION(Foo);
DEFINE_STRUCTURE_DESCRIPTION(Foo);
...
DECLARE_STRUCTURE_DESCRIPTION(Bar);
DEFINE_STRUCTURE_DESCRIPTION(Bar);
