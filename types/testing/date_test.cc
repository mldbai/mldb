...
BOOST_AUTO_TEST_CASE(test_date_parse_iso8601_date_time)
{
...

    {
        ...
        BOOST_CHECK(!Date::parseIso8601DateTime("2013-W00").isADate());
        BOOST_CHECK(!Date::parseIso8601DateTime("2013-W60").isADate());
        ...
        expected = "2013-Jun-03 00:00:00.000";
        BOOST_CHECK_EQUAL(date.print(3), expected);
        BOOST_CHECK(!Date::parseIso8601DateTime("2013-W23-8").isADate());
        BOOST_CHECK(!Date::parseIso8601DateTime("2013-W23-0").isADate());
        date = Date::parseIso8601DateTime("2013-W23-6");
        expected = "2013-Jun-08 00:00:00.000";
        BOOST_CHECK_EQUAL(date.print(3), expected);
        BOOST_CHECK(!Date::parseIso8601DateTime("2013W238").isADate());
        BOOST_CHECK(!Date::parseIso8601DateTime("2013W230").isADate());
    ...
    {
        /* YYYY-DDD or YYYYDDD */
        BOOST_CHECK(!Date::parseIso8601DateTime("2013-000").isADate());
        BOOST_CHECK(!Date::parseIso8601DateTime("2013-367").isADate());
...
BOOST_AUTO_TEST_CASE(test_date_parse_iso8601_time)
{
    ...
    BOOST_CHECK(!Date::parseIso8601Time("24:59:01").isADate());
    BOOST_CHECK(!Date::parseIso8601Time("23:69:01").isADate());
    BOOST_CHECK(!Date::parseIso8601Time("23:09:61").isADate());
...
BOOST_AUTO_TEST_CASE( test_quantize )
{
    ...
    d = Date::parseIso8601DateTime("2013-04-01T09:08:57.765");
    BOOST_CHECK_EQUAL(d.quantized(60.0), Date::parseIso8601DateTime("2013-04-01T09:08:00.000")); //floor on seconds  - see MLDBFB-255
    BOOST_CHECK_EQUAL(d.quantized(1.0), Date::parseIso8601DateTime("2013-04-01T09:08:58.000")); //round on fraction of seconds
    BOOST_CHECK_EQUAL(d.quantized(0.1), Date::parseIso8601DateTime("2013-04-01T09:08:57.800"));
    BOOST_CHECK_EQUAL(d.quantized(0.01), Date::parseIso8601DateTime("2013-04-01T09:08:57.770"));
    BOOST_CHECK_EQUAL(d.quantized(0.001), Date::parseIso8601DateTime("2013-04-01T09:08:57.765"));
}
...
BOOST_AUTO_TEST_CASE( test_fractional_date_print )
{
    ...
    BOOST_CHECK_EQUAL(d1.print(), d2.print(0));
...
BOOST_AUTO_TEST_CASE( test_printIso8601 )
{
    ...
    string expected = "2012-09-19T21:16:40.416978Z";
...
{
    {
        ...
        BOOST_CHECK_EQUAL(start.printIso8601(), "2013-09-08T00:00:00Z");
    }
    {
...
BOOST_AUTO_TEST_CASE( test_iso8601WeekStart )
{
    ...
    BOOST_CHECK_EQUAL(start.printIso8601(), "2013-09-09T00:00:00Z");
...
BOOST_AUTO_TEST_CASE( test_cast_to_int_same_as_quantize_to_second )
{
    {
        auto cast_vs_quantize = [](double secondsSinceEpoch) {
            Date date = Date::fromSecondsSinceEpoch(secondsSinceEpoch);
            uint64_t cast_to_seconds = date.secondsSinceEpoch();
            date.quantize(1.0);
            uint64_t quantized_to_seconds = date.secondsSinceEpoch();
            BOOST_CHECK_EQUAL(cast_to_seconds, quantized_to_seconds);
        };
