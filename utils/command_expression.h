...
struct ConcatExpression : public CommandExpression {
    ...
    virtual std::string applyString(const CommandExpressionContext & vars) const override
    {
        std::string result;
...
struct ArrayExpression: public CommandExpression {
    ...
    virtual Json::Value apply(const CommandExpressionContext & vars) const override
    {
...
struct FunctionExpression : public CommandExpression {
    ...
    virtual Json::Value
    apply(const CommandExpressionContext & context) const override
    {
...
struct PlusExpression: public BinaryArithmeticExpression {
    ...
    virtual Json::Value op(const Json::Value & lhs,
                           const Json::Value & rhs) const override
    {
