...
struct W_multi {
    ...
    */
    ...
    {
#if 1        
        SIMD::vec_minus(&((*this)(0, from,  true )), &(weights(0, true, true)),
                       &((*this)(0, from,  true )), nl());
        SIMD::vec_add  (&(*this)(0, to, true ), &weights(0, true, true),
                       &(*this)(0, to, true ), nl());
        SIMD::vec_minus(&(*this)(0, from,  false), &weights(0, true, false),
                       &(*this)(0, from,  false), nl());
        SIMD::vec_add  (&(*this)(0, to, false), &weights(0, true, false),
                       &(*this)(0, to, false), nl());
#else        
        for (unsigned l = 0;  l < nl();  ++l) {
            Float amount_true = weights(l, true, true);
            (*this)(l, from,  true) -= amount_true;
            (*this)(l, to, true) += amount_true;
            Float amount_false = weights(l, true, false);
            (*this)(l, from,  false) -= amount_false;
            (*this)(l, to, false) += amount_false;
        }
#endif
