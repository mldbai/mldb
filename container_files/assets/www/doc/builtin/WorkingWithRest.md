...
Interactions with MLDB occurs via a REST API ([fully documented here](/doc/rest.html)), where REST stands for [Representational State Transfer](http://en.wikipedia.org/wiki/Representational_state_transfer).
...
The quickest way to get started with making HTTP calls to the MLDB API is with your **web browser** using our [REST API Interactive Documentation](/doc/rest.html).
