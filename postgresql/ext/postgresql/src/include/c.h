...
#include "mldb/postgresql/ext/postgresql/src/include/postgres_ext.h"

/* Must undef pg_config_ext.h symbols before including pg_config.h */
#undef PG_INT64_TYPE

#include "mldb/postgresql/ext/postgresql/src/include/pg_config.h.in"
#include "mldb/postgresql/ext/postgresql/src/include/pg_config_manual.h"	/* must be after pg_config.h */

#if !defined(WIN32) && !defined(__CYGWIN__)		/* win32 includes further down */
//#include "mldb/postgresql/ext/postgresql/src/include/pg_config_os.h"		/* must be before any system header files */
#endif
