...
# $(eval $(call include_sub_make,postgresqlext,ext,postgresqlext.mk))
...
$(eval $(call library,postgresql,$(LIBMLDB_POSTGRESQL_PLUGIN_SOURCES),types utils value_description any postgresqlext))
