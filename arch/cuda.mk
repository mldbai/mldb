...
NVCC       := $(CUDA_INSTALL_PATH)/bin/nvcc -D_FORTIFY_SOURCE=0 -shared -Xcompiler -fPIC,-g,$(OPTIM_FLAG) -arch=sm_13 --ptxas-options=-v $(if $(findstring x1x,x$(CUDA_DEVICE_EMULATION)x),$(NVCC_EMULATION))
