...
$(eval $(call set_compile_option,$(LIBTINYXPATH_SRC),-Imldb/html/ext -Imldb/html/ext/libtinyxpath/src -I$(TMP) -Wno-switch -Wno-parentheses -Wno-unused-variable -Wno-maybe-uninitialized))
