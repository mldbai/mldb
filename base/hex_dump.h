...
*/
void hex_dump(const void * mem, size_t total_memory, size_t max_size = 1024, std::ostream & stream = std::cerr);
void hex_dump(std::string_view mem, size_t max_size = 1024, std::ostream & stream = std::cerr);
