...
$(eval $(call mldb_unit_test,MLDB-663_repeatable_svd.py))
...
$(eval $(call mldb_unit_test,MLDB-1117-git-import.js,,manual)) # manual -- requires the MLDB git repo in the local directory
...
#$(eval $(call mldb_unit_test,MLDB-1277-pooling-performance.py))  # missing data file
...
#$(eval $(call mldb_unit_test,MLDB-1507-groupby.py))  # test depends on random ordering
...
#$(eval $(call mldb_unit_test,MLDB-2180-dataset-split.py)) # test depends on random ordering; needs to be refactored
...
$(eval $(call mldb_unit_test,benchmark-1M-airlines.js,,manual))
$(eval $(call mldb_unit_test,benchmark-10M-airlines.js,,manual))
$(eval $(call mldb_unit_test,benchmark-100M-airlines.js,,manual))